      ...
      <el-row>
        <el-col :lg="24" >
          ...
          <el-form-item label="公司名称" prop="businessName">
            <el-input v-model="formInline.businessName" placeholder="公司名称"></el-input>
          </el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="props">
          <el-button size="mini" round><span @click="handleShowInfo(props.row.appId)" style="cursor: point">{{props.row.businessName}}</span></el-button>
        </template>
      </el-table-column>
      <el-table-column
        width="120"
