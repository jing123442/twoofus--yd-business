<template>
  <div class="model-con">
    <el-form ref="rechargeList" :model="rechargeList" label-width="120px" class="flex">
    ...
    <div class="text-right">
      <el-button type="primary" round size="small" @click="getRechargeList">搜索</el-button>
      <el-button type="success" round size="small" @click='exportRechargeList'>导出</el-button>
    </div>
  ...
  methods: {
    getParam(){
      ...
      if (this.rechargeList.rechargeStatus !== '') {
          this.rechargeList.rechargeStatus = this.rechargeList.rechargeType + this.rechargeList.rechargeStatus
      }
      let temp =  {
    ...
    getRechargeList() {
      financeApi["RECHARGELIST"](this.getParam()).then(res => {
