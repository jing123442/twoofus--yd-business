      ...
      <el-col :span="12" v-for="(item, index) in imgList" :key="index" v-if='index<10'>
        <el-card :body-style="{ padding: '10px' }">
          ...
          <div class="imgtxt">
            ...
            <p><time class="time">{{ item.createTime | FilterTime }}</time></p>
            <div class="flex">
    ...
    <el-dialog
      ...
      width="80%">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="添加图片" prop="src">
          ...
          <el-form-item>
            <el-button type="primary" @click="onSave">立即发布</el-button>
          </el-form-item>
        </el-form>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    onSortUp (id) {
      // console.log(id, this.imgList)
      // console.log(id, this.imgList, this.getIdIndex(id))
      let curIndex = this.getIdIndex(id)
      if (curIndex === -1) {
        return false
      }
